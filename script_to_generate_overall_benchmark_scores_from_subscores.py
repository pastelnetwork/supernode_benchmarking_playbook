...
if __name__ == "__main__":
    input_file_path = f'/home/{YOUR_USER_NAME}/combined_pastel_benchmark_results.json'
    ...
    output_file = f'{output_directory}/combined_pastel_benchmark_results__overall_score_sorted__{timestamp}.json'
